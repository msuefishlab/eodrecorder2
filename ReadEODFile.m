...
%   Modified by J. Gallant to deal with version 2 (Gallant Lab) EOD
%   Binaries
%   $Revision 2.00$  $Date: 2019/05/07 11:00$
...
try
    while k <= numToRead
        ...
        switch info(k).version %JG: handles double encoded voltage values 
            case 2
                [eodwave{k}, count] = fread(fid, nPts, 'double');
