...
![A close up of a fish Description automatically generated](./eod_recording/media/image4.png){width="6.5in" height="2.9243055555555557in"}
...
b.  **Configure Computer**

    We are now exclusively using EODRecorder v2, which collects all of the required metadata. This requires the following be installed on the laptop:

- Matlab 2019a or higher
- Data Acquisition Toolbox
- National Instruments Drivers (if using NI board)
- Hardware support package for national instruments and sound card
